...
function preload(){
  ...
  trex_running = loadAnimation("trex (1).png","trex (2).png","trex (3).png","trex (4).png","trex (5).png");
...
function setup() {
  ...
  backgroundImage=createSprite(500,70);
  backgroundImage.addImage(backgroundImg);
  backgroundImage.scale=1.3;
 
  var message = "This is a message";
 console.log(message)
  
  trex = createSprite(50,160,100,100);
